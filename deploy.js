...
// Corrected artifact path matching your compiled ArizonaForestationDAO contract name
const contractArtifactPath = path.join(__dirname, "out/ArizonaForestationDAO.sol/ArizonaForestationDAO.json");
...
async function main() {
    ...
    const wcProvider = await EthereumProvider.init({
        ...
        metadata: {
            name: "Arizona Forestation DAO Deployment",
            description: "Deploying ArizonaForestationDAO Smart Contract on Arbitrum One",
    ...
    console.log("Preparing deployment transaction for ArizonaForestationDAO...");
    ...
    console.log(`ArizonaForestationDAO Address: ${contractAddress}`);
    console.log(`==========================================\n`);
